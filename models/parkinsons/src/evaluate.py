"""Evaluation script for Parkinson's disease model."""
...
def evaluate_parkinsons_model(
    ...
    model = ParkinsonsModel(model_path=model_path)
    ...
    np.random.seed(123)
    n_samples = 200
    X_test = np.random.rand(n_samples, 22) * 10
